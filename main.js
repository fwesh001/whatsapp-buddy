...
async function handleMessages(sock, messageUpdate, printLog) {
    try {
        ...
        if (isGroup && isAdminCommand) {
            ...
            if (!isBotAdmin) {
                await sock.sendMessage(chatId, { text: 'Budddy you have to make me Admin that command.', ...channelInfo });
                return;
            }
        ...
        if (isOwnerCommand) {
            ...
            if (!message.key.fromMe) {
                await sock.sendMessage(chatId, {
                    text: '❌ Sorry buddy this command can only be used by ⚜𝒵𝒜𝐵_𝒟𝐼𝐸𝐿⚜',
                    ...channelInfo
                });
                return;
            }
        ...
        switch (true) {
            ...
            case userMessage.startsWith('.mode'):
                ...
                if (!message.key.fromMe) {
                    await sock.sendMessage(chatId, { text: 'Sorry Ԇ・Fwesh, Only Ԇ・SAMKIEL can use this Command', ...channelInfo }); //werey
                    return;
                }
